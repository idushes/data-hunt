...
# Copy the application code
COPY server.py config.py database.py models.py dependencies.py security.py alembic.ini utils.py csv_cache.py redis_client.py outbound_queue.py coinbase_capsule.py ./
